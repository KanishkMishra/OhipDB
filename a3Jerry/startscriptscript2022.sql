...
-- add head doctors
UPDATE hospital 
SET headdoc=(SELECT licensenum FROM doctor WHERE lastname="Shabado"), headdocstartdate="2010-12-19" 
WHERE hosname="St. Joseph";

UPDATE hospital 
SET headdoc=(SELECT licensenum FROM doctor WHERE lastname="Aziz"), headdocstartdate="2004-05-30" 
WHERE hosname="Victoria" and city="London";

UPDATE hospital 
SET headdoc=(SELECT licensenum FROM doctor WHERE lastname="Spock"), headdocstartdate="2001-06-01" 
WHERE hosname="Victoria" and city="Victoria";
